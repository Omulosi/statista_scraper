...
def download(url, num_retries=2, user_agent='wswp', proxies=None, scraper=None):
...
def threaded_crawler(start_url, link_regex, robots_url=None, user_agent='wswp',
                 proxies=None, delay=2, max_depth=-1, max_threads=10,
                     scraper=None):
    ...
    In the current implementation, we do not actually scrape any information.
        ...
        kwargs:
            ...
            max_depth (int): maximum crawl depth (to avoid traps) (default: -1)
    """
